    ...
    >
      <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
        ...
        <Link href="/" className="flex flex-col items-start group">
          <span className="font-playfair text-xl font-bold text-gold-gradient tracking-widest uppercase">ROYAL </span>
          <span className="font-cormorant text-xs tracking-[0.35em] text-[#C8A96B] opacity-80 uppercase">ETHNICS WEAR</span>
        </Link>
